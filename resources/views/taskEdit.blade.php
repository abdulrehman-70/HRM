                ...
                <div class="col-12 grid-margin stretch-card">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <h3 class="card-description">Edit Task</h3>
                      <form class="forms-sample" method="POST" action="/update/task/form/{{ $task->id }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="exampleInputname1">Task Title:</label>
                                  <input type="name" name="name" value="{{ $task->name }}" class="form-control">
                                  @error('name')
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="name" name="description" value="{{ $task->description }}" class="form-control">
                                </div>
                                <div class="form-group">
