                ...
                <div class="col-12 grid-margin stretch-card">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <form class="forms-sample" method="POST" action="/user/edit/{{$user->id}}" enctype="multipart/form-data" autocomplete="off">
                        @csrf
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                 <label for="exampleSelectGender">Gender</label>
                                  <select class="form-control"  name="gender" value="{{$user->gender}}" id="exampleSelectGender">
                                   <option>Male</option>
                                ...
                                <div class="form-group">
                                    <label for="birthday">Date of joining</label>
                                     <input type="date" class="form-control" name="date_of_joining"  value="{{$user->date_of_joining}}" id="joining" >
                                ...
                                <input type="file" name="image" value="{{$user->image}}" class="file-upload-default">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" name="address" value="{{$user->address}}" class="form-control" id="exampleInputCity1">
                                @error('address')
                                  <span class="error" style="color:red">{{ $message }}</span>
                                  @enderror
                              </div>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="exampleSelectGender">Designation</label>
                                     <select class="form-control" id="exampleSelectGender" name="designation" value="{{$user->designation}}">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="salary" value="{{$user->salary}}"  id="salary" placeholder="">
                                    @error('salary')
                                    <span class="error" style="color:red">{{ $message }}</span>
                                    @enderror
                                  </div>
                                <div class="form-group">
                                    ...
                                    <input type="tel" class="form-control" name="phone_number" value="{{$user->phone_number}}" id="contactNumber" placeholder="">
                                    @error('phone_number')
                                    <span class="error" style="color:red">{{ $message }}</span>
                                    @enderror
                                  </div>
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"  name="emergency_contact_name" value="{{$user->emergency_contact_name}}" id="emergencyContactName" placeholder="">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="tel" class="form-control" name="emergency_phone_number"  value="{{$user->emergency_phone_number}}" id="emergencyContactNumber" placeholder="">
